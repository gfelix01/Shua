...
export function HairSection() {
  return (
    <section id="extensiones" className="py-20 bg-gradient-to-b from-white to-amber-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <Badge variant="outline" className="mb-4 px-3 py-1 text-sm border-amber-500 text-amber-500">
            100% CABELLO NATURAL
          </Badge>
          <h2 className="text-3xl font-bold mb-4">Extensiones de Cabello Premium</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-amber-600 to-amber-500 mx-auto mb-6"></div>
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 max-w-3xl mx-auto">
          <h3 className="text-xl font-bold mb-6 text-center">¿Por qué elegir nuestro cabello?</h3>
          <Separator className="mb-6 bg-gradient-to-r from-amber-600 to-amber-500" />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold mb-1">100% Cabello humano natural</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold mb-1">Sin enredos</h4>
                  <p className="text-sm text-gray-600">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold mb-1">Puede ser teñido y estilizado</h4>
                  <p className="text-sm text-gray-600">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold mb-1">Durabilidad garantizada</h4>
                  <p className="text-sm text-gray-600">
